...
<div class="col-lg-12">
    <div class="card card-outline card-primary">
         <div class="card-body">
         <form action="new_home.php"  method="POST" >
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="col-sm-6 form-group ">
                                <label for="" class="control-label">id_cdr</label>
                                <input name="id_cdr" id="" class="form-control form-control-sm"  required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group ">
                                ...
                                <select name="categorie" id="id" class="form-control form-control-sm select2" required>
                                    ...
                                    <?php
                                    $rides = $conn->query("SELECT  DISTINCT TYPE FROM lba ");
                        ...
                        <div class="col-sm-6 form-group ">
                            ...
                            <div class="col-sm-6 form-group ">
                                ...
                                <input name="D" id="" class="form-control form-control-sm"  >
                            </div>

                            <div class="col-sm-6 form-group ">
                                <label for="" class="control-label">I</label>
                                <input name="I" id="" class="form-control form-control-sm"  >
                            </div>

                            <div class="col-sm-6 form-group ">
                                <label for="" class="control-label">C</label>
                                <input name="C" id="" class="form-control form-control-sm"  >
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6 form-group ">
                                <label for="" class="control-label">Traitement proposée</label>
                        ...
                        <div class="col-sm-6 form-group ">
                            ...
                            <div class="col-sm-6 form-group ">
                                ...
                                <output name="RISKSCOREBRUT" id="z"  class="form-control form-control-sm number text-right"  onfocus="$(this).select()" onkeyup="update_tbl()" >
                            </div>
                            <div class="col-sm-6 form-group ">
                                <label for="" class="control-label">RNNv</label>
                                <output name="NIVEAURISKBRUT" id="myid2"  class="form-control form-control-sm number text-right"  onfocus="$(this).select()" onkeyup="update_tbl()" >
                            </div>
                            ...
                            <div class="col-sm-6 form-group ">
                                ...
                                <output name="RISKSCOREBRUT" id="k" class="form-control form-control-sm number text-right"  onfocus="$(this).select()" onkeyup="update_tbl()" >
                            </div>
                            <div class="col-sm-6 form-group ">
                                <label for="" class="control-label">RRNv</label>
                                <output name="NIVEAURISKBRUT" id="myid3"  class="form-control form-control-sm number text-right"  onfocus="$(this).select()" onkeyup="update_tbl()" >
                            </div>
...
-->
            ...
            <div class="d-flex w-100 justify-content-center align-items-center">
                ...
                <input   class="btn btn-flat  bg-gradient-primary mx-2" type="submit" name="submit" value="submit">
